...
data_folder = r'C:\Users\dhair\Downloads\Position-Beam-Prediction-main (1)\Position-Beam-Prediction-main\Scenario1' # os.path.join(os.getcwd(), 'DeepSense')
output_folder = os.path.join(os.getcwd(), 'Gathered_data_DEV')
